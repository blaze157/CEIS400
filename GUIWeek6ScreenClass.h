...
static int ButtonCenterX = 175;
static int ButtonLeftX = 50;
static int ButtonRightX = 200;
static int ButtonCenterYstart = 75;
// set starting screen
...
static TCHAR szGenProbEmp[] = _T("Generate Problem Employee Report");
static TCHAR szPrintProblemEmp[] = _T("Print Problem Employees");
...
private:
	...
	int ScreenClassWidth = 500;
	int ScreenClassHeight = 500;
